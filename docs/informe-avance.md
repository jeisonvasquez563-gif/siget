...
- **Ninguna contraseña personal del usuario quedó en los scripts de automatización**: todo comando que requería una contraseña interactiva (`ssh-copy-id`, configuración de sudoers) fue ejecutado directamente por el desarrollador en su propia terminal.
